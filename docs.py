...
class DocumentationGenerator:
    ...
    def generate_openapi_spec(self):
        ...
        from almeza.api.routes import app
        import json
...
def main():
    parser = argparse.ArgumentParser(description='Generate ALMEZA documentation')
    parser.add_argument('--source', default='src/almeza',
