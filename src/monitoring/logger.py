...
class MetricsCollector:
    def __init__(self):
        ...
        self.request_counter = Counter(
            'almeza_requests_total',
            'Total requests processed',
            ['endpoint', 'status']
        )
        
        self.request_latency = Histogram(
            'almeza_request_latency_seconds',
        ...
        self.memory_usage = Gauge(
            'almeza_memory_usage_bytes',
            'Memory usage in bytes'
        )
        
        self.cpu_usage = Gauge(
            'almeza_cpu_usage_percent',
            'CPU usage percentage'
        )
        
        # Model metrics
        self.model_inference_time = Histogram(
            'almeza_model_inference_seconds',
            'Model inference time in seconds',
            ['model_type']
        )
        
        self.model_error_counter = Counter(
            'almeza_model_errors_total',
            'Total model errors',
...
class ElasticSearchHandler:
    def __init__(self, config: Dict[str, Any]):
        ...
        self.index_prefix = config.get('index_prefix', 'almeza-logs-')
...
class StructuredLogger:
    def __init__(self, config: Dict[str, Any]):
        ...
        self.logger = logging.getLogger('almeza')
